...
//  * The client is more complicated. It's job is to play ahead of the server such that it's inputs
//  * arrive just in time for the server to pull them out of the queue and tick forward.
//  *
...
//       let latency = frameTime ? frameTime - receivedTimestamp : null;
