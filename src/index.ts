...
let netplayManager1 = new NetplayManager(true, initialState, initialInputs1, 10, (frame, state) => {
  setTimeout(() => {
...
let netplayManager2 = new NetplayManager(false, initialState, initialInputs2, 10);
